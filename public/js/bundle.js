...
var displayMap = function displayMap(locations) {
  ...
  var bounds = new mapboxgl.LngLatBounds(); //Setting html ele to show on map
...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "C:\\Users\\Fatwani\\Desktop\\NodeJsBootCamp\\4-natours\\starter",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-password').textContent = 'Updating...'; // for innerHtml
